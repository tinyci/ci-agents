...
func (*UnimplementedRepositoryServer) CommentError(context.Context, *CommentErrorRequest) (*empty.Empty, error) {
...
func (*UnimplementedRepositoryServer) SetupHook(context.Context, *HookSetupRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetupHook not implemented")
}
func (*UnimplementedRepositoryServer) TeardownHook(context.Context, *HookTeardownRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TeardownHook not implemented")
}
func (*UnimplementedRepositoryServer) PendingStatus(context.Context, *StatusRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PendingStatus not implemented")
}
func (*UnimplementedRepositoryServer) StartedStatus(context.Context, *StatusRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StartedStatus not implemented")
}
func (*UnimplementedRepositoryServer) ErrorStatus(context.Context, *ErrorStatusRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ErrorStatus not implemented")
}
func (*UnimplementedRepositoryServer) FinishedStatus(context.Context, *FinishedStatusRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FinishedStatus not implemented")
}
func (*UnimplementedRepositoryServer) ClearStates(context.Context, *RepoSHAPair) (*empty.Empty, error) {
