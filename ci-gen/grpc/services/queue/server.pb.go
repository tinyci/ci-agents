...
func (*UnimplementedQueueServer) PutStatus(context.Context, *types.Status) (*empty.Empty, error) {
...
func (*UnimplementedQueueServer) Submit(context.Context, *Submission) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Submit not implemented")
}
func (*UnimplementedQueueServer) SetCancel(context.Context, *types.IntID) (*empty.Empty, error) {
