...
type LogMessage struct {
	...
	At      *timestamp.Timestamp `protobuf:"bytes,1,opt,name=at,proto3" json:"at,omitempty"`           // Time of log
	Level   string               `protobuf:"bytes,2,opt,name=level,proto3" json:"level,omitempty"`     // Level of log (debug, info, error are supported)
	Fields  *_struct.Struct      `protobuf:"bytes,3,opt,name=fields,proto3" json:"fields,omitempty"`   // Fields in map[string]interface{} format
...
func (x *LogMessage) GetAt() *timestamp.Timestamp {
	if x != nil {
		return x.At
	}
	return nil
...
func (x *LogMessage) GetFields() *_struct.Struct {
	if x != nil {
		return x.Fields
	}
	return nil
...
func (*UnimplementedLogServer) Put(context.Context, *LogMessage) (*empty.Empty, error) {
