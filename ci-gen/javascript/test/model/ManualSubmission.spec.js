...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Uisvc.ManualSubmission();
  });
  ...
  describe('ManualSubmission', function() {
    it('should create an instance of ManualSubmission', function() {
      // uncomment below and update the code to test ManualSubmission
      //var instane = new Uisvc.ManualSubmission();
      //expect(instance).to.be.a(Uisvc.ManualSubmission);
    });

    it('should have the property fork (base name: "fork")', function() {
      // uncomment below and update the code to test the property fork
      //var instance = new Uisvc.ManualSubmission();
