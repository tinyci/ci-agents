...
(function(root, factory) {
  ...
  describe('LogMessage', function() {
    it('should create an instance of LogMessage', function() {
      // uncomment below and update the code to test LogMessage
      //var instane = new Uisvc.LogMessage();
      //expect(instance).to.be.a(Uisvc.LogMessage);
    });

    it('should have the property at (base name: "at")', function() {
      // uncomment below and update the code to test the property at
      //var instance = new Uisvc.LogMessage();
