...
let runId = 789; // Number | The ID of the run to retrieve
...
let apiInstance = new Uisvc.DefaultApi();
let id = 789; // Number | The ID of the run to retrieve the log for.
...
let apiInstance = new Uisvc.DefaultApi();
let id = 789; // Number | The ID of the submission to cancel
...
let apiInstance = new Uisvc.DefaultApi();
let id = 789; // Number | The ID of the submission to retrieve
...
let apiInstance = new Uisvc.DefaultApi();
let id = 789; // Number | The ID of the task to retrieve
...
let apiInstance = new Uisvc.DefaultApi();
let id = 789; // Number | the ID of the Task.
