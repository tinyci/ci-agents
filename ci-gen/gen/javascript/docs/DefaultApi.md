...
<a name="capabilitiesUsernameCapabilityDelete"></a>
...
var username = "username_example"; // String | The user ID to remove the capability from. 

var capability = "capability_example"; // String | The name of the capability to remove. 
...
apiInstance.capabilitiesUsernameCapabilityDelete(username, capability, callback);
```
...
<a name="capabilitiesUsernameCapabilityPost"></a>
...
var username = "username_example"; // String | The user ID to add the capability to. 

var capability = "capability_example"; // String | The name of the capability to add. 
...
apiInstance.capabilitiesUsernameCapabilityPost(username, capability, callback);
```
...
apiInstance.loginUpgradeGet(callback);
```
...
# **repositoriesMyGet**
> RepositoryList repositoriesMyGet(opts)
...
apiInstance.repositoriesMyGet(opts, callback);
```
...
> RepositoryList repositoriesSubscribedGet(opts)
...
apiInstance.repositoriesSubscribedGet(opts, callback);
```
...
> RepositoryList repositoriesVisibleGet(opts)
...
apiInstance.repositoriesVisibleGet(opts, callback);
```
