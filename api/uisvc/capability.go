...
func AddCapability(h *handlers.H, ctx *gin.Context) (interface{}, int, *errors.Error) {
	u, err := h.Clients.Data.GetUser(ctx.GetString("username"))
	if err != nil {
		return nil, 500, err
	}

	return nil, 200, h.Clients.Data.AddCapability(u, model.Capability(ctx.GetString("capability")))
}
...
func RemoveCapability(h *handlers.H, ctx *gin.Context) (interface{}, int, *errors.Error) {
	...
	return nil, 200, h.Clients.Data.RemoveCapability(u, model.Capability(ctx.GetString("capability")))
}
